...
!define MUI_WELCOMEPAGE_TITLE "SlideSpeech from ODP v.${SLIDESPEECH_VERSION}"
...
; Finish
!define MUI_FINISHPAGE_TITLE "SlideSpeech from ODP should now be ready to use"
...
DirText "Please choose the directory where you would like SlideSpeech from ODP installed."

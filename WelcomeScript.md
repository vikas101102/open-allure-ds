...
allows one script
to lead to another.
We are in a script called WelcomeScript on the Open Allure Wiki now.

Continue to another web-based script;[http://openallureds.ning.com/profiles/blogs/webbased-script]
[input];;
```
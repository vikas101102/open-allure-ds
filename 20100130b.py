...
def build_problem_text(problem):
   global problem_text, just_question_text, choices, answer_at
   """
...
class VideoCapturePlayer(object):
   ...
   def paint_box(self,ar,xoffset,yoffset,(red,blue,green)):
          ...
          ar[0+xoffset:33+xoffset,0+yoffset:33+yoffset] = (red, blue, green)

   def color_box(self,ar,xoffset,yoffset,(red,blue,green),paintyn):
       # Draw reference lines
       ar[0+xoffset:33+xoffset,33+yoffset]    = (red,blue,green)
       count = 0
       for i in range(1, 11):
          for j in range(1, 11):
             if ar[3*i+xoffset,3*j+yoffset] > 12000000:
                count += 1
       if count > 10:
          count = 10
...
##       pygame.time.wait(1000)
   ...
   def get_and_flip(self):
       ...
       global _stated, highlight, highlight_on, row_time
       ...
       for y_yh in answer_at:
          ...
          for x in range(0,10):
             xspacing = 35
             row_count += self.color_box(ar,x*xspacing,y_yh[0]+20,white,1)
       ...
       if choice > 0: print "In get_and_flip (_stated/p/choice):" + str(_stated) + " " + str(on_problem) + " " + str(choice)
       if not _stated:
           ...
           if choice > 0 and choice <= len(problem_text)-1:
              ...
              text.writewrap(self.display,font,pygame.Rect(20,20,620,460),self.gray,problem_text[choice-1])
               ...
               if highlight > 0:
                  ...
                  text.writewrap(self.display,font,pygame.Rect(20,20,620,460),(255,int(255*color_level/6),0),problem_text[highlight])
